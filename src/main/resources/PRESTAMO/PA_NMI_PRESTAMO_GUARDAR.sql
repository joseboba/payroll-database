CREATE OR REPLACE PROCEDURE PA_NMI_PRESTAMO_GUARDAR(
    ...
    P_IN_PRE_FECHA_INICIO IN VARCHAR,
...
BEGIN
    ...
    INSERT INTO NMI_PRESTAMO(EPU_CODIGO, PRE_MONTO, PRE_INTERES, PRE_CANTIDAD_MESES, PRE_CUOTA_MENSUAL, PRE_DESCRIPCION, PRE_FECHA_INICIO)
        VALUES (V_EMPLEADO_PUESTO, P_IN_PRE_MONTO, P_IN_PRE_INTERES, P_IN_PRE_CANTIDAD_MESES, V_CUOTA_MENSUAL, P_IN_PRE_DESCRIPCION, TO_TIMESTAMP(P_IN_PRE_FECHA_INICIO, 'DD-MM-YYYY'))
