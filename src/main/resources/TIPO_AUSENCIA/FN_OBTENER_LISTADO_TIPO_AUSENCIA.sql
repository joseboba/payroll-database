...
WHERE
    (P_IN_SEARCH IS NULL OR TAU_CODIGO LIKE '%' || UPPER(P_IN_SEARCH) || '%') OR
    (P_IN_SEARCH IS NULL OR TAU_NOMBRE LIKE '%' || UPPER(P_IN_SEARCH) || '%') OR
    (P_IN_SEARCH IS NULL OR TAU_DESCRIPCION LIKE '%' || UPPER(P_IN_SEARCH) || '%') OR
    (P_IN_SEARCH IS NULL OR TAU_GOCE_SALARIO LIKE '%' || UPPER(P_IN_SEARCH) || '%')
